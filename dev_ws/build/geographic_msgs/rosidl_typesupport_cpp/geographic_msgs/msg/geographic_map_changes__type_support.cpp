...
static const _GeographicMapChanges_type_support_symbol_names_t _GeographicMapChanges_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geographic_msgs, msg, GeographicMapChanges)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geographic_msgs, msg, GeographicMapChanges)),
  }
};
...
{
  return &::geographic_msgs::msg::rosidl_typesupport_cpp::GeographicMapChanges_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, geographic_msgs, msg, GeographicMapChanges)() {
  return get_message_type_support_handle<geographic_msgs::msg::GeographicMapChanges>();
}
