...
def generate_test_description():
    ...
    aggregator_node = ExecuteProcess(
        cmd=[
            ...
            "--ros-args",
            "--params-file",
            "/home/administrador/Desktop/dev_ws/src/diagnostics/diagnostic_aggregator/test/analyzer_group.yaml"
            ],
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, launch_service, proc_info, proc_output):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/administrador/Desktop/dev_ws/src/diagnostics/diagnostic_aggregator/test/expected_output/output_analyzer_group"),
