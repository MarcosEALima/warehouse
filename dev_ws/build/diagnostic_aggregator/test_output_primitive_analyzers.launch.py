...
test_listener = ExecuteProcess(
    cmd=[
        "/usr/bin/python3",
        "/home/administrador/Desktop/dev_ws/src/diagnostics/diagnostic_aggregator/test/test_listener.py"
        ],
    name='test_listener',
    emulate_tty=True,
    output='screen')
...
def generate_test_description():
    ...
    aggregator_node = ExecuteProcess(
        cmd=[
            "/home/administrador/Desktop/dev_ws/install/diagnostic_aggregator/lib/diagnostic_aggregator/aggregator_node",
            "--ros-args",
            "--params-file",
            "/home/administrador/Desktop/dev_ws/src/diagnostics/diagnostic_aggregator/test/primitive_analyzers.yaml"
            ],
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, launch_service, proc_info, proc_output):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/administrador/Desktop/dev_ws/src/diagnostics/diagnostic_aggregator/test/expected_output/output_primitive_analyzers"),
