...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, aggregator_node):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/administrador/Desktop/dev_ws/src/diagnostics/diagnostic_aggregator/test/expected_output/create_empty_root_path"),
