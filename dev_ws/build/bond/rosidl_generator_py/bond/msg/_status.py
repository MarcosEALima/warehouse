...
class Status(metaclass=Metaclass_Status):
    ...
    def __init__(self, **kwargs):
        ...
        self.heartbeat_timeout = kwargs.get('heartbeat_timeout', float())
        self.heartbeat_period = kwargs.get('heartbeat_period', float())
    ...
    def __eq__(self, other):
        ...
        if self.heartbeat_timeout != other.heartbeat_timeout:
            return False
        if self.heartbeat_period != other.heartbeat_period:
            return False
        return True
    ...
    def heartbeat_timeout(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'heartbeat_timeout' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'heartbeat_timeout' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._heartbeat_timeout = value

    @builtins.property
    def heartbeat_period(self):
        """Message field 'heartbeat_period'."""
    ...
    def heartbeat_period(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'heartbeat_period' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'heartbeat_period' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
